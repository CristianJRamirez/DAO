...
public class Main {
     ...
     * @throws InstantiationException
     */
    private static void afegirRecursosColeccions() throws XMLDBException, ClassNotFoundException, IllegalAccessException, InstantiationException{

        pedirNombreCollection();
     ...
     */
    private static void pedirNombreCollection() {
     ...
     */
    private static void pedirNombreRescurso() {
     ...
     */
    private static void pedirConsulta() {
     ...
     */
    private static void pedirRutaXML() {
